...
contract Datastore is Pausable {
    ...
    // Completed audits
    event CompletedAudit(address indexed _auditor, address indexed _deployer, address _contract, address _hash, bool indexed _approved, uint256 _contractIndex);
     ...
     */
    function auditorApprovedContract(address _auditor, uint256 _index) external view returns (address, address, address, address, bool, bool) {
    ...
    /**
        ...
        @return The audited contract information
     */
    function auditorOpposedContract(address _auditor, uint256 _index) external view returns (address, address, address, address, bool, bool) {
    ...
    /**
        ...
        @return Boolean value indicating if this address has been addede to the store
     */
    function hasContractCreationRecord(address _creationHash) external view returns (bool) {
     ...
     */
    function contractDetails(address _contract) external view returns (address, address, address, address, bool, bool) {
        return _contractDetails(_contract);
    }

    function searchAllStoresForContractDetails(address _contract) external view returns (address, address, address, address, bool, bool) {
     ...
     */
    function completeAudit(address _auditor, address _deployer, address _contract, address _txHash, bool _approved) external onlyOwner() whenNotPaused() {
        require(activeStore, "Store has been deactivated");
        ...
        uint256 _contractIndex = _saveContract(_auditor, _contract, _deployer, _txHash, _approved);
        ...
        emit CompletedAudit(_auditor, _deployer, _contract, _txHash, _approved, _contractIndex);
    }
