...
contract Platform is Pausable {
    ...
    function completeAudit(address _auditor, address _deployer, address _contract, address _hash, bool _approved) external whenNotPaused() {  
        ...
        (bool _storeSuccess, ) = dataStore.call(abi.encodeWithSignature("completeAudit(address,address,address,address,bool)", _auditor, _deployer, _contract, _hash, _approved));
    ...
    function migrateAuditor(address _auditor) external {
        ...
        (bool _success, ) = dataStore.call(abi.encodeWithSignature("migrateAuditor(address,address)", _initiator, _auditor));
